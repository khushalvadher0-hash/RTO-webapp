...
function ServiceTypePage() {
  ...
  if (normalizedParam === "all") {
    return <ServiceDashboard serviceType={"Insurance" as ServiceType} title="All Completed Services" description="All completed application services across all categories" />;
  }
